...
public class One extends Attacker
{
	...
	public void move()
	{
		...
		if (img.getTranslateX() < closest - window.getWidth() * .05208333) // img.getTranslateX() <
																			// enemy.getTranslateX() - 100)
		{
	...
	/*
	 * public void moveEnemy() { TranslateTransition t = new TranslateTransition();
	 * 
	 * t.setDuration(Duration.millis(1)); t.setNode(imgEnemy);
	 * t.setToX(imgEnemy.getTranslateX() - 5); if(imgEnemy.getTranslateX() > 0 &&
	 * imgEnemy.getTranslateX() > enemy.getTranslateX() + 100) t.setOnFinished(e ->
	 * {
	 * 
	 * moveEnemy();
	 * 
