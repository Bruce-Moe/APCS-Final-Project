...
public class TroopControl extends GameMenuDemo
{
	...
	public void setMenu() throws FileNotFoundException
	{
		...
		FileInputStream inputstream3 = new FileInputStream("res/imgs/1.png");
	...
	public ImageView createTroop(Attacker a) throws Exception
	{
		...
		if (a instanceof One)
		{
			Image m = new Image(new FileInputStream("res/imgs/1.png"), window.getHeight() * .165,
					window.getHeight() * .165, false, false);
			img = new ImageView(m);
